...
# Extract source code
cd /home/root/
tar -xzf /home/root/install/scidb-15.12.1.4cadab5.tar.gz 
mv scidb-15.12.1.4cadab5 scidbtrunk
...
apt-get update
apt-get install -y --force-yes --no-install-recommends scidb-15.12-libboost1.54-all-dev  scidb-15.12-cityhash scidb-15.12-libcsv scidb-15.12-libmpich2-1.2 scidb-15.12-libmpich2-dev  scidb-15.12-ant 
apt-get install -y --force-yes --no-install-recommends fakeroot build-essential debhelper fop xsltproc doxygen subversion ant-optional libpam-dev swig2.0 docbook-xsl scidb-15.12-mpich2
